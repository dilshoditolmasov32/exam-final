      ...
      <div className="container">
        <div className="flex gap-6 mb-[150px] mt-[15px] max-lg:grid max-lg:grid-cols-1 max-lg:justify-items-center max-lg:mb-[120px] max-md:mb-[80px] max-sm:mb-[60px] max-xs:mb-[40px]">
          ...
          <div className="max-w-[504px] w-full p-10 bg-white rounded-[8px] max-lg:max-w-[980px] max-lg:w-full max-xs:p-3">
            <h4 className="mb-4 text-[20px] font-bold text-[#1F1D14]">Итого</h4>
            <div className="flex justify-between mb-4 ">
              ...
              <div className="text-end">
                Сумма:
                <h3 className="text-[#000] text-[22px] font-semibold">
                  <span className="text-[#1F1D14] text-[24px]">250 000 uzs</span>
                </h3>
              </div>
            </div>
            <h4 className="my-6 text-[20px] font-bold text-[#1F1D14]">Ваши данные</h4>
            ...
            <p  className="mb-2 text-[#1F1D14] ">Ваш номер</p>
              ...
              <TextField
                ...
                autoFocus={false}
              />
              <h4 className="my-6 text-[20px] font-bold text-[#1F1D14] ">Тип оплаты</h4>
            ...
            <button className="py-[20px]  my-10 px-[30px] max-w-[424px] w-full bg-[#FBD029] rounded-[5px] text-[24px] font-bold max-lg:w-full ">Купить</button>
